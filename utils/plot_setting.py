...
plot_vars_titles = {
    ...
    'vtx_njets':['vtx_njets','SV # of asso. jets', '# events'],
    'vtx_nbjets_loose': ['vtx_nbjets_loose','SV # of asso. loose b jets', '# events'],
    'vtx_nbjets_medium': ['vtx_nbjets_medium','SV # of asso. medium b jets', '# events'],
    'vtx_nbjets_tight': ['vtx_nbjets_tight','SV # of asso. tight b jets', '# events'],
    'vtx_nbtks_loose': ['vtx_nbtks_loose','SV # of tracks from loose b jets', '# events'],
    'vtx_nbtks_medium': ['vtx_nbtks_medium','SV # of tracks from medium b jets', '# events'],
    'vtx_nbtks_tight': ['vtx_nbtks_tight','SV # of tracks from tight b jets', '# events'],
...
plot_setting = {
    ...
    'vtx_njets': {'range':(0,20), 'bins':20},
    'vtx_nbjets_loose': {'range':(0,20), 'bins':20},
    'vtx_nbjets_medium': {'range':(0,20), 'bins':20},
    'vtx_nbjets_tight': {'range':(0,20), 'bins':20},
    'vtx_nbtks_loose': {'range':(0,20), 'bins':20},
    'vtx_nbtks_medium': {'range':(0,20), 'bins':20},
    'vtx_nbtks_tight': {'range':(0,20), 'bins':20},
